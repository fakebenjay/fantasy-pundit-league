class WideReceiversController < ApplicationController
  def new
    if !WideReceiver.find_by(search_name: params['name'].downcase, week: params['week'])
      ...
      @wide_receiver = WideReceiver.find_by(search_name: params['name'].downcase, week: params['week'])
      render json: @wide_receiver, serializer: WideReceiverSerializer
    end
  end
end
